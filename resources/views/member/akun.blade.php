            	...
            	<h4>Edit Data</h4>
      					...
      					<div class="col-md-6">
      						<div class="row" style="margin:10px 10px 10px 10px">
      							<div class="form-group has-feedback">
      								...
      								<input type="text" name="username" class="form-control" placeholder="Username" value="{{ $member->username }}" pattern="[a-z0-9_]{4,16}" data-pattern-error = "Username hanya boleh mengandung huruf kecil, angka, dan underscore (4-16 karakter)." data-required-error="Username wajib diisi." required>
      						...
      						<div class="row" style="margin:10px 10px 10px 10px">
      							<div class="form-group has-feedback">
      								...
      								<input type="email" name="email" class="form-control" placeholder="Email" value="{{ $member->email }}" data-error="Format email salah." data-required-error="Email wajib diisi." required>
      						...
      						<div class="row" style="margin:10px 10px 10px 10px">
      							<div class="form-group has-feedback">
      								...
      								<input type="text" name="nomor_hp" class="form-control" placeholder="08xxxxxxxxxx" value="{{ $member->nomor_hp }}" pattern="08[0-9]{8,11}" data-pattern-error="Format nomor HP salah. Contoh: 081234567890 (10-13 digit)." data-required-error="Nomor HP wajib diisi." required>
      						...
      						<div class="row" style="margin:10px 10px 10px 10px">
      							<div class="form-group has-feedback">
      								...
      								<input type="text" name="nomor_wa" class="form-control" placeholder="08xxxxxxxxxxx" value="{{ $member->nomor_wa }}" pattern="08[0-9]{8,11}" data-pattern-error="Format nomor HP salah. Contoh: 081234567890 (10-13 digit).">
      					...
      					<div class="col-md-6">
      						<div class="row" style="margin:10px 10px 10px 10px">
      							<div class="form-group has-feedback">
      								...
      								<input type="text" name="nama_lengkap" class="form-control" placeholder="Nama lengkap sesuai identitas" value="{{ $member->nama_lengkap }}" data-required-error="Nama lengkap wajib diisi." required>
                  ...
                  <div class="row" style="margin:10px 10px 10px 10px">
      							<div class="form-group has-feedback">
      								...
      								<select name="jenis_kelamin" class="form-control" required>
      									<option value="0"@if ($member->jenis_kelamin === 1) selected @endif> Laki-laki </option>
      									<option value="1"@if ($member->jenis_kelamin === 0) selected @endif> Perempuan </option>
      								</select>
      								<div class="help-block with-errors"></div>
      							</div>
      						</div>
                  <div class="row" style="margin:10px 10px 10px 10px">
      							<div class="form-group has-feedback">
      								...
      								<select name="mahasiswa_ipb" class="form-control" required>
